...
export class CreateWalletTables1686834627685 implements MigrationInterface {
    name = 'CreateWalletTables1686834627685'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."transactions_transaction_type_enum" AS ENUM('DEPOSIT', 'WITHDRAW', 'TRANSFER')`);
        ...
        await queryRunner.query(`CREATE TABLE "clients" ("client_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(255) NOT NULL, "balance" integer NOT NULL, CONSTRAINT "PK_49e91f1e368e3f760789e7764aa" PRIMARY KEY ("client_id"))`);
