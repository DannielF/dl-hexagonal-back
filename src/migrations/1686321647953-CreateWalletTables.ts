...
export class CreateWalletTables1686321647953 implements MigrationInterface {
    name = 'CreateWalletTables1686321647953'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clients" ("client_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(255) NOT NULL, "document_id" character varying(255) NOT NULL, "balance" integer NOT NULL, CONSTRAINT "PK_49e91f1e368e3f760789e7764aa" PRIMARY KEY ("client_id"))`);
